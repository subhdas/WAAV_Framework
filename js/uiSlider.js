    ...
    var extensionMethods = {
        ...
        pips: function (settings) {
            ...
            var options = {
                ...
                step: (pips > 500) ? Math.floor(pips * 0.5) : 1.5,
                // number
                //changed
                formatLabel: function (value) {
                        var res = this.prefix + value + this.suffix;
                        //console.log(res);
                        return res;
                    }
                    // function
            ...
            slider.element
                ...
                .on("mousedown.selectPip", function (e) {
                    ...
                    console.log("UISlider.js: Value is :" + $handle.toString());
            ...
            slider.element.on("slide.selectPip slidechange.selectPip", function (e, ui) {
                ...
                //console.log("UISlider.js: Value is ; " + values);
                yearValues = [];
                if (values[0] != values[1]) {
                    for (var i = +values[0]; i < +values[1]; i++) {
                        yearValues.push(i);
                ...
                $(document).ready(function () {
                    ...
                    $(".clMenuHead").text(txt);
                    year = values[1];
                    console.log("UISlider.js: calling init");
                    //clean();
                    //init();
