...
var lc_width = 1700 - lc_margin.left - lc_margin.right;
var lc_height = 620 - lc_margin.top - lc_margin.bottom;
...
//load the line chart
function loadLineChart(c1, c2) {
    lc_country1 = c1;
    lc_country2 = c2;
    readLineChartData(true);
}

//read in the line chart data
function readLineChartData(loadLCVisBool) {
    ...
    d3.csv("data/AggregatedArmsData.csv", function (lc_dataset) {
        ...
        for (var i = 1992; i < 2012; i++) { // pad the data with 0s
        	...
        	if (!found) {
        		// add an entry
        		lc_c1Data.push({ Country1: lc_country1, Continent1: "placeholder", Country2: lc_country1, Continent2: "placeholder", Year: i, Value: "0" } );
        	}
        }
        ...
        for (var i = 1992; i < 2012; i++) { // pad the data with 0s
        	...
        	if (!found) {
        		// add an entry
        		lc_c2Data.push({ Country1: lc_country2, Continent1: "placeholder", Country2: lc_country1, Continent2: "placeholder", Year: i, Value: "0" } );
        	}
        }
...
function updateLineChartData() {
    d3.csv("data/AggregatedArmsData.csv", function (lc_dataset) {
        ...
        for (var i = 1992; i < 2012; i++) { // pad the data with 0s
        	...
        	if (!found) {
        		// add an entry
        		lc_c1Data.push({ Country1: lc_country1, Continent1: "placeholder", Country2: lc_country2, Continent2: "placeholder", Year: i, Value: "0" } );
        	}
        }
        lc_c2Data = lc_data.filter(function (d) {
            return d["Country1"] == lc_country2;
